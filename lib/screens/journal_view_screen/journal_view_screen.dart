...
class _JournalViewScreenState extends State<JournalViewScreen> {
  ...
  @override
  void initState() {
    mentalStrengthEditProvider = Provider.of<MentalStrengthEditProvider>(
      context,
      listen: false,
    );
  ...
  void init() async {
    ...
    await homeProvider.fetchJournalDetails(
        journalId: widget.journalId, context: context);
  ...
  Widget build(BuildContext context) {
    ...
    return PopScope(
      ...
      child: ConnectivityWidget(
        child: SafeArea(
          child: Consumer3<MentalStrengthEditProvider, DashBoardProvider,
                  HomeProvider>(
              builder: (context, mentalStrengthEditProvider, dashBoardProvider,
                  homeProvider, _) {
            return Scaffold(
              appBar: buildAppBarJournalViewScreenNew(context, size,
                  heading: "View your journal", onTap: () {
                mentalStrengthEditProvider.openGoalViewSheet = false;
                mentalStrengthEditProvider.goalDetailModel = null;
                ...
                child: Padding(
                  ...
                  child: Consumer<HomeProvider>(
                    ...
                    return SingleChildScrollView(
                      child: mentalStrengthEditProvider.openGoalViewSheet ==
                              false
                              ...
                              : Column(
                                  ...
                                  children: [
                                    ...
                                    SizedBox(
                                      ...
                                      child: Builder(
                                        builder: (context) {
                                          final journal = homeProvider
                                              .journalDetails?.journals;
                                          final journalDesc =
                                              journal?.journalDesc?.trim() ??
                                                  "";
                                          final previewLink =
                                              journal?.preview_link?.trim() ??
                                                  "";

                                          final hasDesc =
                                              journalDesc.isNotEmpty;
                                          final hasPreview =
                                    ...
                                    audioList.isEmpty
                                        ...
                                        : SizedBox(
                                            ...
                                            // Default height if more than 2 audios
                                                              ...
                                                              child: Stack(
                                                                children: [
                                                                  Positioned
                                                                      .fill(
                                                                    child:
                                                                        VideoPlayerWidgetViewAndAlreadyBuildMentalProgressBar(
                                                                      videoUrl:
                                                                          videoList[
                                                                              index],
                                                                    ),
                                                        ...
                                                        child: ClipRRect(
                                                          borderRadius:
                                                              BorderRadius
                                                                  .circular(5),
                                                          child:
                                                              VideoPlayerWidgetViewAndAlreadyBuildMental(
                                                            videoUrl: videoList[
                                                                index],
                                                          ),
                                                        ),
                                    ...
                                    homeProvider.journalDetails == null
                                        ...
                                        : CustomRatingBar(
                                            ...
                                            initialRating: double.parse(
                                              homeProvider.journalDetails!
                                                      .journals!.emotionValue
                                                      ?.toString() ??
                                                  '0',
                                            ),
                                            itemSize: 35,
                                            isRatingStatic:
                                                true, // Set to true to make rating unchangeable
                                          ),
                                                    ...
                                                    if (actionId != null) {
                                                      await mentalStrengthEditProvider
                                                          .fetchActionDetails(
                                                              ...
                                                              context: context);
                                                      debugPrint(
                                                          "✅ Fetched action details for ID: $actionId");
                                    ...
                                    homeProvider.journalDetails?.journals
                                                ...
                                                null &&
                                            homeProvider.journalDetails!
                                                .journals!.chatlink!.isNotEmpty
                                        ? GestureDetector(
                                            onTap: () {
                                              final linkUrl = homeProvider
                                                  .journalDetails
                                                  ?.journals
                                                  ?.chatlink;
                                              final chatTitle = homeProvider
                                                  .journalDetails
                                                  ?.journals
                                                  ?.chatpage_title;
  ...
  Widget _buildUntitledOne(BuildContext context, Size size) {
    return Row(
      ...
      mainAxisAlignment: MainAxisAlignment.center,
      children: [
        Consumer2<EditProfileProvider, HomeProvider>(
            builder: (context, editProfileProvider, homeProvider, _) {
          return Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Container(
                            ...
                            PopupMenuItem<String>(
                              onTap: () async {
                                ...
                                if (homeProvider.journalDetails != null) {
                                  ...
                                  if (homeProvider
                                          .journalDetails!.journals!.location !=
                                      null) {
                                    mentalStrengthEditProvider
                                  ...
                                  mentalStrengthEditProvider
                                      .emotionalValueStar = double.parse(
                                    homeProvider
                                        .journalDetails!.journals!.emotionValue
                                        .toString(),
                                  );
                                  ...
                                  if (homeProvider
                                    ...
                                    mentalStrengthEditProvider.goalsValue =
                                      ...
                                      id: homeProvider.journalDetails!.journals!
                                          .goal!.goalId
                                          .toString(),
                                      title: homeProvider.journalDetails!
                                ...
                                customPopup(
                                  ...
                                  onPressedDelete: () {
                                    journalListProvider
                                      ...
                                      for (var journals
                                          in homeProvider.journalsModelList) {
              ...
              homeProvider.journalDetails!.journals!.location == null
                  ...
                  : GestureDetector(
                      onTap: () {
                        ...
                        final double lat =
                            double.tryParse(loc!.locationLatitude.toString()) ??
                                0.0;
                        final double lng =
                            double.tryParse(loc.locationLongitude.toString()) ??
                                0.0;
...
// Updated launch function
  void _launchInAppWithBrowserOptions(
      Uri url, String title, BuildContext context) async {
  ...
  Future<void> openLocationInGoogleMaps(double lat, double lng) async {
    final url =
